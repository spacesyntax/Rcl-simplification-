...
class RclSimplificationDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        ...
        self.minSegLenSpin.setDecimals(1)
        self.minSegLenSpin.setRange(0, 100)
        self.minSegLenSpin.setSingleStep(0.1)
        ...
        self.maxAngleDevSpin.setRange(0, 20)
        self.maxAngleDevSpin.setSingleStep(1)
        self.maxAngleDevSpin.setValue(10)
        self.maxAngleDevSpin.setSuffix(unichr(176))
        self.interDistSpin.setDecimals(1)
        self.interDistSpin.setRange(0, 100)
        self.interDistSpin.setSingleStep(0.1)
        ...
        self.minLenDevSpin.setValue(5)
        self.minLenDevSpin.setSuffix(' m')
        self.maxLenDevSpin.setDecimals(1)
        self.maxLenDevSpin.setRange(0, 100)
        self.maxLenDevSpin.setSingleStep(0.1)
        self.maxLenDevSpin.setValue(8)
        self.maxLenDevSpin.setSuffix(' m')
