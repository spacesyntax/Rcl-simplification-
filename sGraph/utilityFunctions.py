...
def get_column_name_types(layer):
    "SELECT column_name, data_type FROM information_schema.columns WHERE TABLE_NAME = self.road_layer_name;"
    return names_type_string
